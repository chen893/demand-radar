  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="glass-premium rounded-2xl p-6 space-y-6 animate-fade-in relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-2">
              {PROVIDERS.map((p) => (
                <label
                  key={p.value}
                  className={`
                      relative flex items-center p-3.5 border rounded-xl cursor-pointer transition-all duration-200
                      ${
                        provider === p.value
                          ? "border-blue-500 bg-blue-50/50 ring-1 ring-blue-500 z-10 shadow-sm"
          ...
          <div>
            ...
            <div className="relative group">
              <input
                ...
                className="w-full pl-3 pr-10 py-3 bg-white/80 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-mono shadow-sm hover:border-gray-300"
              />
              <button
                type="button"
        ...
        <div className="glass-premium rounded-2xl p-6 space-y-4 relative overflow-hidden">
          {/* Decorative background element */}
          <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-gradient-to-tr from-gray-200/20 to-transparent rounded-full pointer-events-none" />

          <div className="flex items-center gap-3 mb-2 relative z-10">
            <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-lg shadow-sm">
              💾
            </div>
            <div>
              <h2 className="font-bold text-gray-900 leading-tight">
        ...
        {/* About Card */}
        <div className="glass-premium rounded-2xl p-6 relative overflow-hidden mb-8">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-lg bg-purple-50 flex items-center justify-center text-lg shadow-sm">
              ℹ️
            </div>
            <div>
              <h2 className="font-bold text-gray-900 leading-tight">关于</h2>
              <p className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">
                Demand Radar v1.0.0
              </p>
            </div>
